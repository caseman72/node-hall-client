...
var _ = require('underscore'),
  ...
  IO = Module.extend({
    ...
    onClientConnect : function(connection) {
      var me = this;
      debug('websocket is connected to '+streamWSURL(me, me.session).href+'....');
    ...
    onConnect : function(data) {
      debug('======================================================');
      debug('Hall is hiring engineers. Say hello! jobs@hall-inc.com');
      debug('======================================================');
      debug('connected!!!');
      var me = this;
      try {
        ...
        console.error('Hall IOConnect error');
      }
      return me;
    },
    ...
    onMessage : function(message) {
      ...
      try {
        ...
        console.error(e)
        console.error('onIOEvent Listener Error');
      }
